...
import TicketTypeCard from "../pages/pre-built/ticketTypes/TicketTypeCard";
...
const Router = () => {
  ...
  return (
    <Routes>
      ...
      {/* <Route exact path={`${process.env.PUBLIC_URL}/ecommerce/index`} component={EcomDashboard}></Route> */}
      <Route path="ecommerce/index" element={<EcomDashboard />}></Route>
      <Route path={`${process.env.PUBLIC_URL}`} element={<Layout />}>
        ...
        <Route path="ticketTypeCard" element={<TicketTypeCard />}></Route>
        <Route path="ticketTypeList" element={<TicketTypeList />}></Route>

        <Route element={<UserContextProvider />}>
          <Route path="ticket-lists-default" element={<UserListDefault />}></Route>
